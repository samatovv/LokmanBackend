    ...
    <Container>
      <div className="w-full mx-auto grid md:grid-cols-2 gap-12 mt-15">
        ...
        <div className="flex flex-col gap-4 text-[#184363]">
          ...
          <p className="text-2xl font-semibold py-5 text-[#15A8E3]">
            ${product.price}
          </p>
          ...
          <div className="flex items-center gap-4 mt-6">
            <a
              href="tel:+996500288588"
              className="bg-[#15A8E3] flex items-center gap-4 text-[#ffffff] px-6 py-3 rounded-full hover:bg-[#184363] hover:text-white transition no-underline"
            >
              <p>Узнать цену</p>
            </a>
          </div>
